...
baseDir <- getwd() # should work for anyone if you have the conteStreamTemperature_northeast.Rproj loaded
...
# Source functions (now should be part of package)
...
# Save the output
save(springFallBPs, file = paste0(dataLocalDir, outFile, '.RData'))
```
