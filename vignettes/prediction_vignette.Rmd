...
For one site how do you loop through to calculate the time series (when site-specific values, no site-specific coefficient values, huc values, year values)
